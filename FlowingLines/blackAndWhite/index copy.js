...
var radius = 1;
var objcolor = ['rgba(11,102,35,0.01)','rgba(63,122,77,0.01)','rgba(199,234,70,0.01)'];
var colorlistlength = objcolor.length-1;
...
function draw() {
    ...
    stroke(objcolor[Math.round(Math.random()*colorlistlength)]);
    fill(objcolor[Math.round(Math.random()*colorlistlength)]);
